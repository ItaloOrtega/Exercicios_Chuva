...
/**
 * Faz o scrpping da pagina.
 */
class Scrapper {

  /**
   * Carrega as informações do HTML e cria uma tabela com os valores dos artigos.
   */
  public function scrap(\DOMDocument $dom): void {
    ...
    #For para ser possível alocar a qtd máxima de autores possiveis
